...
import { CheckmarkSVG, EmailSVG, PersonSVG, UploadSVG } from '../images/icon';
                                    ...
                                    <fieldset disabled>
                                        ...
                                        <div className="mb-5.5">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    className={`w-full rounded border border-stroke bg-gray
                                        ...
                                        <div className="flex justify-end gap-4.5">
                                            ...
                                            <button
                                                ...
                                                hover:shadow-1 disabled:opacity-50
                                                "
                                                type="submit"
                                            >
                                                Save
                                    ...
                                    <fieldset disabled>
                                        <div className="mb-4 flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <span className="flex gap-2.5">
                                                    <button className="text-sm hover:text-primary disabled:opacity-50">
                                                        Delete
                                                    </button>
                                                    <button className="text-sm hover:text-primary disabled:opacity-50">
                                                        Update
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-col items-center justify-center space-y-3">
                                                <span className="flex h-10 w-10 items-center justify-center rounded-full border border-stroke bg-white dark:border-strokedark dark:bg-boxdark text-[#3C50E0]">
                                                    <UploadSVG />
                                                </span>
                                                <p>
