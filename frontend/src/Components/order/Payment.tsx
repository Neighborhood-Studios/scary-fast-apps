...
const testingInfo = (
  <table className="m-auto">
    <caption>
      <h4>Dev Section</h4>
      <p>
        Use test payment details and the test redirect page to verify your
        integration. The following table contains some basic test scenarios. For
        detailed information about testing payments, see{' '}
    ...
    <tbody>
      <tr>
        <td>Credit card</td>
        <td>The card payment succeeds and doesn’t require authentication.</td>
        <td>
          Fill out the credit card form using the credit card number{' '}
          <code className="InlineCode">4242 4242 4242 4242</code> with any
      ...
      <tr>
        ...
        <td>
          Fill out the credit card form using the credit card number{' '}
          <code className="InlineCode">4000 0025 0000 3155</code> with any
          expiration, CVC, and postal code.
        </td>
      </tr>
      <tr>
        ...
        <td>
          Fill out the credit card form using the credit card number{' '}
          <code className="InlineCode">4000 0000 0000 9995</code> with any
          expiration, CVC, and postal code.
        </td>
      </tr>
      <tr>
        <td>Credit card</td>
        <td>The UnionPay card has a variable length of 13-19 digits.</td>
        <td>
          Fill out the credit card form using the credit card number{' '}
          <code className="InlineCode">6205 500 0000 0000 0004</code> with any
          expiration, CVC, and postal code.
        </td>
      </tr>
    </tbody>
